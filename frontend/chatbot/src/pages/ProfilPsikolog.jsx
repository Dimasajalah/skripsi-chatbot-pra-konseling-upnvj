//frontend/chatbot/src/pages/ProfilPsikolog.jsx
    ...
    <PsikologLayout>
      <div style={styles.container}>
        ...
        <div style={{ marginBottom: 24 }}>
          <h2 style={styles.pageTitle}>Profil Psikolog</h2>
          <p style={styles.pageDesc}>
            Kelola informasi akun psikolog Anda.
          </p>
        </div>
...
/* ================= STYLES (IDENTIK DENGAN MAHASISWA) ================= */
